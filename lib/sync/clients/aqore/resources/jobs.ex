defmodule Sync.Clients.Aqore.Resources.Jobs do
  @moduledoc false
  ...
  def list_jobs(details, limit, offset, sync) do
    payload =
    ...
    list_jobs_data(details, payload)
  end

  defp list_jobs_data(%{"base_api_url" => base_api_url, "access_token" => access_token}, payload) do
