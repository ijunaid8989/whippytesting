defmodule Sync.Workers.Avionte.CustomData.AvionteContactsTest do
  ...
  alias Sync.Workers.Avionte.CustomData.AvionteContacts
  ...
  describe "process/1 for process_contacts_as_custom_object_records" do
    ...
    test "logs an error when the contact custom object is not found" do
      ...
      assert capture_log(fn ->
             ...
             end) =~ "No custom object found for contact."
    end
