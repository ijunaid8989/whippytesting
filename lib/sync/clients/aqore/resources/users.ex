defmodule Sync.Clients.Aqore.Resources.Users do
  @moduledoc false
  ...
  @doc """
  List users from Aqore
  """
  def list_users(details, limit, offset, sync) do
    payload =
    ...
    list_users_data(details, payload)
  end

  defp list_users_data(%{"base_api_url" => base_api_url, "access_token" => access_token}, payload) do
